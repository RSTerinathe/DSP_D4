...
origin_locations = pd.read_csv('../data/firestations.csv')
...
csv_file = open('../data/travelling_times_firestations.csv', 'w', newline='')
...
for demand_point in demand_locations.iterrows():
    ...
    for origin in origin_locations.iterrows():
        ...
        if calculateDistanceFromCoordinates(origin_lat, origin_lng, demand_lat, demand_lng) < 3700:
